"use strict";
window.characterCreator.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.characterCreator.state){
			this.game.state.add(stateName, window.characterCreator.state[stateName]);
		}
